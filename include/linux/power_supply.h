...
#ifdef ZS670KS
enum {
	POWER_SUPPLY_ASUS_STATUS_CHARGING = 0,
	POWER_SUPPLY_ASUS_STATUS_QUICK_CHARGING,
	POWER_SUPPLY_ASUS_STATUS_QUICK_CHARGING_PLUS,
	POWER_SUPPLY_ASUS_STATUS_HYPER_CHARGING,
	POWER_SUPPLY_ASUS_STATUS_THERMAL_ALERT,
};
#endif
