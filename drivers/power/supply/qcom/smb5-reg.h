...
#define CHARGER_ERROR_STATUS_SFT_EXPIRE_BIT	BIT(2) //ASUS BSP +++
#define CHARGER_ERROR_STATUS_BAT_OV_BIT		BIT(1)
#define CHARGER_ERROR_STATUS_BAT_MISSING_BIT	BIT(0) //ASUS BSP +++
...
#define SOC_BASED                               BIT(1) //ASUS BSP +++

#define PRE_CHARGE_CURRENT_CFG_REG		(CHGR_BASE + 0x60)
#define PRE_CHARGE_CURRENT_SETTING_MASK		GENMASK(2, 0) //ASUS BSP ---

#define CHGR_FAST_CHARGE_CURRENT_CFG_REG	(CHGR_BASE + 0x61)
#define CHGR_FAST_CHARGE_CURRENT_SETTING_MASK	GENMASK(7, 0) //ASUS BSP +++

#define TCCC_CHARGE_CURRENT_TERMINATION_CFG_REG	(CHGR_BASE + 0x63)
#define TCCC_CHARGE_CURRENT_TERMINATION_SETTING_MASK	GENMASK(3, 0) //ASUS BSP ---
...
#define CHGR_SAFETY_TIMER_ENABLE_CFG_REG	(CHGR_BASE + 0xA0) //ASUS BSP +++
...
#define DCDC_OTG_CURRENT_LIMIT_MASK		GENMASK(2, 0) //ASUS BSP +++
...
#define HVDCP_PULSE_COUNT_MAX_QC3_MASK         GENMASK(5, 0) //ASUS BSP +++
enum {
...
#define USBIN_ADAPTER_ALLOW_CFG_REG		(USBIN_BASE + 0x60) //ASUS BSP +++
...
#define USBIN_CURRENT_LIMIT_MASK		GENMASK(7, 0) //ASUS BSP +++
...
#define TYPEC_LEGACY_CABLE_TYPE_MASK			GENMASK(1, 0) //ASUS BSP +++
...
#define EN_LEGACY_CABLE_DETECTION_BIT	BIT(0) //ASUS BSP ---
...
#define THERMREG_INOV_ENABLE			GENMASK(2, 0) //ASUS BSP +++
